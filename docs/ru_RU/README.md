...
[english](https://github.com/senseyman/mtproto/blob/main/README.md) **русский** [简体中文](https://github.com/senseyman/mtproto/blob/main/docs/zh_CN/README.md)
...
**Примеры кода [здесь](https://github.com/senseyman/mtproto/blob/main/examples)**

**Полная документация [здесь](https://pkg.go.dev/github.com/senseyman/mtproto)**
...
**Пример [здесь](https://github.com/senseyman/mtproto/blob/main/examples/auth)**
...
Нужно работать с этими стрёмными `tg://` ссылками? Загляните в [пакет `deeplinks`](https://github.com/senseyman/mtproto/blob/main/telegram/deeplinks), вот самый простейший пример:
...
Please read [contributing guide](https://github.com/senseyman/mtproto/blob/main/docs/ru_RU/CONTRIBUTING.md) if you want to help. And the help is very necessary!

**Don't want code?** Read [this](https://github.com/senseyman/mtproto/blob/main/.github/SUPPORT.md) page! We love nocoders!

## Критические уязвимости?

Ага, мы стараемся подходить к ним серьезно. Пожалуйста, не создавайте ищью, описывающие ошибку безопасности, это может быть ОЧЕНЬ небезопасно! Вместо этого рекомендуем глянуть на [эту страничку](https://github.com/senseyman/mtproto/blob/main/.github/SECURITY.md) и следовать инструкции по уведомлению.
...
This project is licensed under the MIT License - see the [LICENSE](https://github.com/senseyman/mtproto/blob/main/docs/ru_RU/LICENSE.md) file for details
